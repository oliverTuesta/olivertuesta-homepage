    ...
    return (
        <Container>
            ...
            <SimpleGrid columns={[1, 1, 2]} gap={6}>
                ...
                >
                    A product landing page made with HTML, CSS and JavaScript.
                </WorkGridItem>
                <WorkGridItem
                    id="lead-your-way"
                    title="Lead Your Way"
                ...
                >
                    A Discord bot that allows users to download wallpapers from
                    Wallhaven made with Node.js and Discord.js.
                </WorkGridItem>
            </SimpleGrid>
        </Container>
    );
